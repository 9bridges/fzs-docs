...
:::
:::caution
当链路源端为 Oracle 时，部署 Web Server 需要使用其二进制版本，请联系技术支持获取软件包 <a target="_blank" href="http://192.168.0.198:1721/repository/maven-releases/fzs/Linux/webserver/0.7.4/webserver-0.7.4.gz" download="webserver-0.7.4.gz">webserver-0.7.4.gz</a>
:::
